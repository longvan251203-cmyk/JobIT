...
<head>
    ...
    <title>JobIT- Trang web tìm việc làm IT</title>
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <a class="btn-getstarted flex-md-shrink-0" href="index.html#about">Đăng nhập</a>
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                        <h1 data-aos="fade-up">Nền tảng kết nối việc làm Công nghệ thông tin - Trường Đại học Cần Thơ
                        </h1>
                        <p data-aos="fade-up" data-aos-delay="100">Hỗ trợ ứng viên và doanh nghiệp trong lĩnh vực công
                            nghệ</p>
            ...
            <div class="container" data-aos="fade-up">
                <div class="row gx-0">
                    ...
                    <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up"
                        ...
                        <div class="content">
                            <h3>VỀ CHÚNG TÔI</h3>
                            <h2>Cầu nối giữa Đại học Cần Thơ và doanh nghiệp CNTT.</h2>
                            <p>
                                Job-IT hỗ trợ sinh viên và cựu sinh viên Đại học Cần Thơ kết nối nhanh chóng với doanh
                                nghiệp uy tín trong lĩnh vực Công nghệ thông tin. Từ thực tập đến việc làm chính thức,
                                chúng tôi luôn là người bạn đồng hành đáng tin cậy.
                            </p>
