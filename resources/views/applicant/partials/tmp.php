        ...
        <div class="job-listings mt-4">
            ...
            <div class="job-card {{ $matchClass }}">
                    ...
                    <div class="criteria-grid">
                        ...
                        <div class="criteria-item">
                            ...
                            <div class="progress-bar-wrapper">
                                <div class="progress-fill {{ $getScoreLevel($details['skills']['score']) }}"
                                    style="width: {{ $details['skills']['score'] }}%"></div>
                            </div>
                        ...
                        <div class="criteria-item">
                            ...
                            <div class="progress-bar-wrapper">
                                <div class="progress-fill {{ $getScoreLevel($details['experience']['score']) }}"
                                    style="width: {{ $details['experience']['score'] }}%"></div>
                            </div>
                            <div class="criteria-reason">
                        ...
                        <div class="criteria-item">
                            ...
                            <div class="progress-bar-wrapper">
                                <div class="progress-fill {{ $getScoreLevel($details['location']['score']) }}"
                                    style="width: {{ $details['location']['score'] }}%"></div>
                            </div>
                            <div class="criteria-reason">
                        ...
                        <div class="criteria-item">
                            ...
                            <div class="progress-bar-wrapper">
                                <div class="progress-fill {{ $getScoreLevel($details['salary']['score']) }}"
                                    style="width: {{ $details['salary']['score'] }}%"></div>
                            </div>
                            <div class="criteria-reason">
                        ...
                        <div class="criteria-item">
                            <div class="criteria-header">
                                ...
                                <div class="criteria-score {{ $getScoreLevel($details['education']['score']) }}">
                                    {{ number_format($details['education']['score'], 0) }}%
                                </div>
                            </div>
                            <div class="progress-bar-wrapper">
                                <div class="progress-fill {{ $getScoreLevel($details['education']['score']) }}"
                                    style="width: {{ $details['education']['score'] }}%"></div>
                            </div>
                            <div class="criteria-reason">
                                {{ $details['education']['reason'] }}
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="criteria-item">
                            ...
                            <div class="progress-bar-wrapper">
                                <div class="progress-fill {{ $getScoreLevel($details['language']['score']) }}"
                                    style="width: {{ $details['language']['score'] }}%"></div>
                            </div>
                            <div class="criteria-reason">
                ...
                <div class="job-actions">
                    <a href="{{ route('job.details', $job->job_id) }}"
